...
class ScriptArguments:
    ...
    deepspeed: Optional[str] = field(
        ...
        metadata={
            'help':
            "Path to deepspeed config if using deepspeed. \
    ...
    bf16: Optional[bool] = field(
        ...
        metadata={
            'help':
            'This essentially cuts the training time in half if you want to sacrifice a little precision \
                  and have a supported GPU.'
        },
    )
...
train_dataset = load_dataset('lvwerra/stack-exchange-paired',
                             data_dir='data/reward',
                             split='train')
if script_args.train_subset > 0:
    train_dataset = train_dataset.select(range(script_args.train_subset))
eval_dataset = load_dataset('lvwerra/stack-exchange-paired',
