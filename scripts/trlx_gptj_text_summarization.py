...
if __name__ == '__main__':
    ...
    def get_prompt_dataset(prompts, max_length):
        """Get the prompt after T5 decoding to make sure dictionary of prompts
        and summaries is consistent decode prompt from trlX pipeline."""
        formatted_prompts = []
    ...
    val_set = [(sample['prompt'], sample['label'])
