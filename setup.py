...
if __name__ == '__main__':
    ...
    with open('chatgpt/__version__.py') as fh:
    ...
    setup(
        ...
        description='open-chatgpt is a open source chatbot framework.',
        ...
        keywords=['chatgpt', 'rlhf', 'llm'],
        python_requires='>=3.7',
        url='https://github.com/jianzhnie/open-chatgpt',
    )
